    ...
    <div className="main-div">
      ...
      <div >
        ...
        <div className="square-wrapper">
          ...
          arr.map((e,colIndex)=>{
              return <Square
               id={rowIndex*3+colIndex} currentElement={e} playingAs={playingAs}
                socket={socket} key={rowIndex*3+colIndex} finishedArrayState={finishedArrayState} gameState={gameState} finishedState={finishedState} setFinishedState={setFinishedState} setGameState={setGameState} setCurrentPlayer={setCurrentPlayer} currentPlayer={currentPlayer}/>
          }))}
        </div>
        ...
        {finishedState&&finishedState!=='opponentLeftMatch'&&finishedState==='draw'&&<h3 className="finished-state">Draw Match</h3>}
